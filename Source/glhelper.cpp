...
----------------------------------------------------------------------------- */
GLHelper* GLHelper::glhelper = nullptr;
...
This function prints the OpenGL context information.
*/
void GLHelper::print_specs()
{
    ...
    GLubyte const* str_shadingver = glGetString(GL_SHADING_LANGUAGE_VERSION);

    std::cout << "GPU Vendor: " << str_ven << std::endl
        << "GL Renderer: " << str_ren << std::endl
        << "GL Version: " << str_ver << std::endl
        << "GL Shader Version: " << str_shadingver << std::endl;

    GLint major_ver;
    glGetIntegerv(GL_MAJOR_VERSION, &major_ver);
    std::cout << "Gl Major Version: " << major_ver << std::endl;

    GLint minor_ver;
    glGetIntegerv(GL_MINOR_VERSION, &minor_ver);
    std::cout << "Gl Major Version: " << minor_ver << std::endl;
    ...
    std::cout << "Maximum Vertex Indices: " << indices_count << std::endl;
    ...
    glGetIntegerv(GL_MAX_VIEWPORT_DIMS, viewport_size);
    std::cout << "Maximum Viewport Dimensions: " << viewport_size[0] << " x " << viewport_size[1] << std::endl;
}